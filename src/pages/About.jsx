...
export default function About() {
  ...
  const images = Array.isArray(pharmacyInfo?.images) ? pharmacyInfo.images.filter(Boolean) : []
  const img0 = images[0] || 'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=1200&q=80'
  const img1 = images[1] || 'https://images.unsplash.com/photo-1631549916768-4119b2e5f926?w=1200&q=80'
  const img2 = images[2] || 'https://images.unsplash.com/photo-1622902046580-2b47f47f5471?w=1200&q=80'
        ...
        <div className="about-grid">
          <div className="fade-up">
            <div style={{ borderRadius: 'var(--radius-lg)', overflow: 'hidden', marginBottom: 20 }}>
              <img src={img0} alt="" style={{ width: '100%', height: 280, objectFit: 'cover' }} />
            </div>
            <div className="grid grid-2">
              <img src={img1} alt="" style={{ borderRadius: 'var(--radius-md)', height: 140, objectFit: 'cover', width: '100%' }} />
              <img src={img2} alt="" style={{ borderRadius: 'var(--radius-md)', height: 140, objectFit: 'cover', width: '100%' }} />
            </div>
          </div>
